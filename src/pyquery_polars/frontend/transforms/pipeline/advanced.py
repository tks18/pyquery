"""
Advanced step renderers - Class-based UI components for advanced operations.
...
class CustomScriptStep(BaseStepRenderer[CustomScriptParams]):
    """Renderer for the custom_script step - custom Python transformation."""

    def render(self, step_id: str, params: CustomScriptParams,
               schema: Optional[pl.Schema] = None) -> CustomScriptParams:
